...
var Commands, buildTemplate, clearScreen, endsWith, exec, fs, getPaths, getSoyCommand, http, i, path, pathModule, project, runCommands, runCommandsAsyncTimer, runServer, soyPath, soyPaths, start, tests, watchOptions, watchPaths, _i, _len;
...
buildTemplate = function() {
  return exec("node assets/js/dev/build " + project + " --html");
};
...
start = function() {
  ...
  runServer();
  buildTemplate();
  fs.watchFile("" + project + "-template.html", watchOptions, function(curr, prev) {
...
Commands = {
  ...
  deps: {
    timeout: 2000,
    command: "python assets/js/google-closure/closure/bin/build/depswriter.py      --root_with_prefix=\"assets/js/google-closure ../../../google-closure\"      --root_with_prefix=\"assets/js/dev ../../../dev\"      --root_with_prefix=\"assets/js/este ../../../este\"      --root_with_prefix=\"assets/js/" + project + " ../../../" + project + "\"      > assets/js/deps.js"
  },
  tests: tests.run,
